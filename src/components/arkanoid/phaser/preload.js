...
class Preload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("musica", "/assets/sounds/arkanoid/BGM-Echelon.mp3");
    this.load.audio('impactoNaveSample', '/assets/sounds/arkanoid/click.wav');
    this.load.audio('choqueBarra', '/assets/sounds/arkanoid/choque_barra.mp3');
    this.load.audio('choqueBloques', '/assets/sounds/arkanoid/choque_bloques.mp3');
    this.load.audio('perder', '/assets/sounds/arkanoid/perder.mp3');
  }
